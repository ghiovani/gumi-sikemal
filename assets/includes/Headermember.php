				...
				<div id="main-header">
					...
					<div class="row">	
						...
						<div class="col-lg-1 col-md-1 col-sm-1">
							...
							<!-- <blockquote>Sistem Informasi Untuk Mengetahui Kebudayaan Malang..</blockquote> -->
				...
				<div id="lower-header">
					...
					<ul id="navigation">
						...
						<li <?php if($candidate['current-menu-item'] == 'Profil') echo 'class="current-menu-item"'; ?>>
							<a href="<?php echo base_url()?>Member/DisplayProfil">Profil</a>						
						</li>
						<!-- /Home -->
						...
						<!-- Donate -->
						<li <?php if($candidate['current-menu-item'] == 'write story') echo 'class="current-menu-item"'; ?>>
							<a href="<?php echo base_url()?>Story/DisplayFormWriteStory">Write Story</a>
						</li>
						<!-- /Donate -->
