...
<section id="content">	
	...
	<?php foreach ($query as $row) {} ?>
		<h1><a href="<?php echo base_url(); ?>Informasi_Kuliner/getIsi/<?php echo "$row->id_post";?>"><?php echo $row->judul; ?></a></h1>
 ...
 <!-- komentar -->
				...
				<div class="issue-isi">
                  	<form method="post" action="<?php echo base_url(); ?>Informasi_Kuliner/SubmitKomentar/<?php echo "$row->id_post";?>">
                    <textarea type="text" id="newsletter-form" placeholder="what's on your mind" name="komentar" /> </textarea>
				...
				<!-- <div class="issue-isi">
                	<a href="<?php echo base_url(); ?>Informasi_Kuliner/lihatKomentar/<?php echo "$row->id_post";?>"><i>lihat semua komentar</i></a>
                </div> -->
