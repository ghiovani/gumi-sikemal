...
<?php foreach ($query as $row) {} ?>
	...
	<section class="section full-width-bg gray-bg">
		...
		<div class="sidebar-box white animate-onscroll">
			<form action="<?php echo base_url(); ?>Lokasi_Budaya/submitLokasiBudaya/" method="post">
			<div class="newsletter-zip">
			<input type="text" name="nama_lokasi"  placeholder="nama lokasi" required/>
			</div>
			<div class="newsletter-zip">
			<br><p>copy paste link embed lokasi di google map<p>
			<p>Perlu Bantuan?<a href="#help"><i class="icons icon-camera"></i></a></p>
			
			<input type="text" name="location"  Placeholder="link peta lokasi(embed)" required/>
			</div>
