			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<a href="DisplayFormTambah" class="button button-arrow">Tambah Konten</a>
							...
							<tr>
								...
								<td width="35%">
								<a href="getIsi/<?php echo "$row->id_event";?>" class="button">Baca</a>
								<a href="DisplayFormUpdate/<?php echo "$row->id_event";?>" class="button">Edit</a>
								<a href="DeleteData/<?php echo "$row->id_event";?>" onclick="return confirm('Anda yakin akan menghapus Soal ini?')" class="button">Hapus</a>
								</td>
							</tr>
							<?php
							$no++;
