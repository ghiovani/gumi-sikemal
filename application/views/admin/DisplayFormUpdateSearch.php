...
$candidate['page-title'] = 'Pencarian'; // Page Title
...
<?php foreach ($query as $row) {} ?>
		...
		<p class="breadcrumb">admin/Sejarah/<?php echo "$row->judul"; ?></p>
	...
	<section class="section full-width-bg gray-bg">
		...
		<div class="newsletter-form">
			<form action="<?php echo base_url();?>Pencarian/updateInformasiSearch/<?php echo "$row->id_post";?>" enctype="multipart/form-data" method="post">
