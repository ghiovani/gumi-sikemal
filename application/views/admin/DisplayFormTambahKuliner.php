...
<?php foreach ($query as $row) {} ?>
	...
	<section class="section full-width-bg gray-bg">
		...
		<div class="newsletter-form">
			<form action="<?php echo base_url(); ?>Informasi_Kuliner/submitInformasiKuliner" enctype="multipart/form-data" method="post">
			<div class="newsletter-zip">
			<input type="text" name="judul"  placeholder="Judul Informasi Kuliner" required/>
			</div>
