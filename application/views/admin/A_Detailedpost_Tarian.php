...
<section id="content">	
	...
	<?php foreach ($query as $row) {} ?>
		<h1><a href="<?php echo base_url(); ?>Informasi_Tarian/getIsi/<?php echo "$row->id_post";?>"><?php echo $row->judul; ?></a></h1>
 ...
 <!-- komentar -->
				...
				<div class="issue-isi">
                  	<form method="post" action="<?php echo base_url(); ?>Informasi_Tarian/SubmitKomentar/<?php echo "$row->id_post";?>">
				...
				<!-- <div class="issue-isi">
                	<a href="<?php echo base_url(); ?>Informasi_Tarian/lihatKomentar/<?php echo "$row->id_post";?>"><i>lihat semua komentar</i></a>
                </div> -->
