...
<?php foreach ($query as $row) {} ?>
		<h1>Tarian Malang</h1>
		<p class="breadcrumb">admin/Tarian/<?php echo "$row->judul"; ?></p>
	...
	<section class="section full-width-bg gray-bg">
		...
		<div class="newsletter-form">
			<form action="<?php echo base_url(); ?>Informasi_Tarian/updateInformasiTarian/<?php echo "$row->id_post";?>" enctype="multipart/form-data" method="post">
