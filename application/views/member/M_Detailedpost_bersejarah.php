...
<section id="content">	
	...
	<?php foreach ($query as $row) {} ?>
		<h1><a href="<?php echo base_url(); ?>Informasi_Bersejarah/getIsi/<?php echo "$row->id_post";?>"><?php echo $row->judul; ?></a></h1>
 ...
 <!-- komentar -->
				...
				<div class="issue-isi">
                  	<form method="post" action="<?php echo base_url(); ?>Informasi_Bersejarah/SubmitKomentar/<?php echo "$row->id_post";?>">
