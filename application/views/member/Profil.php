					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4" >
							...
							?>
								...
								<img style="height:85%;width:85%;" src="<?php echo base_url(); ?>assets/img/member/<?php echo "$row->foto";?>" alt=""></br>
						...
						<div class="col-lg-8 col-md-4 col-sm-4" >
							...
							<?php 
								foreach ($query as $row) {
							?>
							<a class="btn" href="<?php echo base_url(); ?>member/DisplayformEditProfil/<?php echo "$row->uid";?>">Edit Profil</a>
							<?php 
							}
							?>
								</tr>
