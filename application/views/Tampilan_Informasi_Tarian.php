...
<section id="content">	
	...
	<section class="section page-heading animate-onscroll">
		...
		<h1>Tarian Malang</h1>
		<p class="breadcrumb"><a href="<?php echo base_url(); ?>home">Home</a> / Tarian</p>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 animate-onscroll">
								...
								<div class="issue-block">
									...
									<div class="issue-content">
										...
										<a class="button big button-arrow" href="<?php echo site_url('Informasi_Tarian/getIsi/'.$row->id_post);?>" target="_blank">Read more</a>
